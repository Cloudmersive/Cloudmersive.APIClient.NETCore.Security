...
(Get-Content ./client/src/Cloudmersive.APIClient.NETCore.Security/Cloudmersive.APIClient.NETCore.Security.csproj).replace('<AssemblyTitle>Swagger Library</AssemblyTitle>', "<AssemblyTitle>Cloudmersive Security API Client</AssemblyTitle>") | Set-Content ./client/src/Cloudmersive.APIClient.NETCore.Security/Cloudmersive.APIClient.NETCore.Security.csproj
(Get-Content ./client/src/Cloudmersive.APIClient.NETCore.Security/Cloudmersive.APIClient.NETCore.Security.csproj).replace('<Description>A library generated from a Swagger doc</Description>', "<Description>The security APIs help you detect and block security threats.</Description>") | Set-Content ./client/src/Cloudmersive.APIClient.NETCore.Security/Cloudmersive.APIClient.NETCore.Security.csproj
...
(Get-Content ./client/README.md).replace(' automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project', " for the [Cloudmersive Security API](https://www.cloudmersive.com/security-threat-detection-api)") | Set-Content ./client/README.md
