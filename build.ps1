...
(Get-Content ./client/README.md).replace(' automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project', " for the [Cloudmersive Security API](https://www.cloudmersive.com/security-api)") | Set-Content ./client/README.md
